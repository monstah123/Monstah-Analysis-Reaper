...
export const mockAssets: AssetData[] = [
  ...
  { id: 'GBPUSD', name: 'GBP/USD', category: 'Forex', avFrom: 'GBP', avTo: 'USD', bias: 'Neutral', score: 0, basePrice: 1.2650, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 60, cotShort: 55, retailLong: 52, retailShort: 48 },
  { id: 'USDCAD', name: 'USD/CAD', category: 'Forex', avFrom: 'USD', avTo: 'CAD', bias: 'Neutral', score: 0, basePrice: 1.3650, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 45, cotShort: 50, retailLong: 48, retailShort: 52 },
  { id: 'USDCHF', name: 'USD/CHF', category: 'Forex', avFrom: 'USD', avTo: 'CHF', bias: 'Neutral', score: 0, basePrice: 0.9020, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 18, cotShort: 35, retailLong: 44, retailShort: 56 },
