...
export const mockAssets: AssetData[] = [
  ...
  { id: 'COPPER', name: 'COPPER', category: 'Commodities', bias: 'Neutral', score: 0, basePrice: 4.5, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0 },
  ...
  { id: 'USOIL', name: 'USOIL', category: 'Commodities', bias: 'Neutral', score: 0, basePrice: 83.5, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0 },
  { id: 'UKOIL', name: 'BRENT OIL', category: 'Commodities', bias: 'Neutral', score: 0, basePrice: 89.4, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 0, cotShort: 0, retailLong: 50, retailShort: 50 },
  { id: 'SILVER', name: 'SILVER', category: 'Commodities', coingeckoId: 'silver', bias: 'Neutral', score: 0, basePrice: 28.5, cot: 0, retailPos: 0, seasonality: 0, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0 },
