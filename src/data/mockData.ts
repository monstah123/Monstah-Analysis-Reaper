...
export const mockAssets: AssetData[] = [
  ...
  { id: 'GBPUSD', name: 'GBP/USD', category: 'Forex', avFrom: 'GBP', avTo: 'USD', bias: 'Bullish', score: 4, basePrice: 1.2650, cot: 1, retailPos: 1, seasonality: 1, trend: 1, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 145, cotShort: 85, retailLong: 42, retailShort: 58 },
  { id: 'USDCAD', name: 'USD/CAD', category: 'Forex', avFrom: 'USD', avTo: 'CAD', bias: 'Bearish', score: -3, basePrice: 1.3650, cot: -1, retailPos: -1, seasonality: -1, trend: 0, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 45, cotShort: 110, retailLong: 68, retailShort: 32 },
  { id: 'USDCHF', name: 'USD/CHF', category: 'Forex', avFrom: 'USD', avTo: 'CHF', bias: 'Neutral', score: 0, basePrice: 0.9020, cot: 0, retailPos: 0, seasonality: 1, trend: -1, gdp: 0, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 0, employmentChange: 0, unemploymentRate: 0, interestRates: 0, cotLong: 38, cotShort: 35, retailLong: 54, retailShort: 46 },
  ...
  { id: 'UKOIL', name: 'BRENT OIL', category: 'Commodities', bias: 'Bullish', score: 6, basePrice: 89.4, cot: 1, retailPos: -1, seasonality: 1, trend: 2, gdp: 0, mPMI: 0, sPMI: 1, retailSales: 0, inflation: 1, employmentChange: 0, unemploymentRate: 0, interestRates: -1, cotLong: 320, cotShort: 110, retailLong: 42, retailShort: 58 },
