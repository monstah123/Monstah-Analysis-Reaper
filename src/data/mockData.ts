...
export const mockAssets: AssetData[] = [
  ...
  { id: 'EURUSD', name: 'EUR/USD', category: 'Forex', avFrom: 'EUR', avTo: 'USD', bias: 'Neutral', score: 1, basePrice: 1.1586, cot: 0, retailPos: 1, seasonality: 1, trend: 0, gdp: -1, mPMI: 0, sPMI: 0, retailSales: 0, inflation: 1, employmentChange: 0, unemploymentRate: 0, interestRates: -1 },
